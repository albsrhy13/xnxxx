...
async def join_channel():
    try:
        await sython(JoinChannelRequest("SOURCE_NEON"))
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id :
        order = await event.reply('Hi My Developer [ VENOM ](tg://openmessage?user_id=5345637082)')
